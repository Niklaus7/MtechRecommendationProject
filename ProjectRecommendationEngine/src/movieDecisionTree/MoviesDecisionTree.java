 ...
 *
 */
public class MoviesDecisionTree implements Serializable {
	...
	public Double demo() {
		...
		String datapath = "Recommendations/MovieDecisionTree/data/MovieTreeDataset"; // for poker dataset
		JavaRDD<LabeledPoint> data = MLUtils.loadLibSVMFile(jsc.sc(), datapath).toJavaRDD();

		String givenDatapath = "Recommendations/MovieDecisionTree/data/givenData";
...
//	}
	public static void main(String[] args) {
		...
		MoviesDecisionTree cd = new MoviesDecisionTree();
		cd.demo();
